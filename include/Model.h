...
public:
    ...
    virtual void setExitMessage(const std::string &errorMessage) = 0;
    ...
    virtual const std::string &getExitMessage() = 0;
...
public:
    ...
    Model() : _applicationMode(""), _filePassword(""), _filePath(""), _fileKey(""), _fileLifetime(""), _exitMessage("") {}
    ...
    void setExitMessage(const std::string &exitMessage) override;
    ...
    const std::string &getExitMessage() override;
