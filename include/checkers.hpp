...
#define INIT_VALUE 0
#define SUCCESS 0
#define NO_DATA_WAS_READ 1

#define DOWNLOAD_MODE 'd'
#define UPLOAD_MODE 'u'
...
enum KEY_ERROR {
    NOT_KEY_VALUE = 2, OUT_OF_BORDER_KEY
};
...
#define MIN_FILE_LIFETIME_DAYS 1
#define MAX_FILE_LIFETIME_DAYS 7
#define MAX_FILE_LIFETIME_LENGTH 2
